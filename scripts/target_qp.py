...
from tracking_experiment.msg import EstimateOutput
from tracking_experiment.msg import CameraFeatures
from tracking_experiment.msg import Trajectory3D
from tracking_experiment.msg import FunctionSwitch
import cvxopt
...
rospy.init_node('target_qp', anonymous=True)
...
def quadratic_progamming():
    ...
    function_sub = rospy.Subscriber('/uav0/tracking/function_select', FunctionSwitch, callback3, queue_size=1)
